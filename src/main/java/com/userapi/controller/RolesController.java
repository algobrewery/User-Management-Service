...
public class RolesController {
    ...
    @PostMapping("/bootstrap-organization-admin-role")
    public Mono<ResponseEntity<String>> bootstrapOrganizationAdminRole(
            @Valid @RequestBody BootstrapOrganizationAdminRoleRequest request,
            HttpServletRequest httpRequest) {

        String organizationUuid = HeaderValidationUtil.getValidatedOrganizationUuid(httpRequest);
        String adminUserUuid = request.getAdminUserUuid();
